"""
Django settings for auchibbg project.
...
WSGI_APPLICATION = 'auchibbg.wsgi.application'
...
if USE_S3:
    ...
    # s3 media settings
    DEFAULT_FILE_STORAGE = 'auchibbg.storage_backends.MediaStorage'
else:
    STATIC_URL = '/static/'
...
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend' #for production purpose
